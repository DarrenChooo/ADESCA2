...
/////////////////////////////////////////////////////////////////////
import DialogueInteractionContent from "./components/DialogueInteractionContent.js";
...
const DialogueInteraction = () => {
  ...
  React.useEffect(() => {
    ...
    axios.get(USER_URL + `/getplotid/${userid}`).then(response => {
    ...
    .then(() => {
      console.log(floorid);
      axios.get(FLOOR_API_URL + floorid, {}).then(floor => {
    ...
    axios.get(NPC_URL + `/${getNpcId}`, {}).then(response => {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    id: "header"
  }, /*#__PURE__*/React.createElement("h1", null, "Conversation with ", npcName)), /*#__PURE__*/React.createElement(DialogueInteractionContent, {
    npcName: npcName,
    npcImageUrl: npcImageUrl
  }));
};
const root = ReactDOM.createRoot(document.getElementById("root"));
root.render( /*#__PURE__*/React.createElement(DialogueInteraction, null));