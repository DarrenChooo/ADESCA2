...
import AllFloors from "./components/AllFloors.js";
...
const UserFloor = () => {
  ...
  useDidMountEffect(() => {
    axios({
      ...
      const npcArr = [];
      response.data.map(value => npcArr.push(value.imageurl));
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, error ? /*#__PURE__*/React.createElement(ErrorPage, {
  ...
  }) : selectedFloor ? /*#__PURE__*/React.createElement(AllFloors, {
    ...
    setError: setError
  }), /*#__PURE__*/React.createElement(GameBarButtons, {
    setSelectedFloor: setSelectedFloor
  }), /*#__PURE__*/React.createElement(GameBackgroundImage, {
    floorId: floorId,
    setError: setError
  }), gameStatus == 'waiting' ? /*#__PURE__*/React.createElement("div", {
    className: "overlay"
  }, /*#__PURE__*/React.createElement("div", {
    className: "playerCtn"
  }, /*#__PURE__*/React.createElement(LoadingSpinner, {
    setLoadingWords: loadingWords
  }))) : gameStatus == 'not ready' ? /*#__PURE__*/React.createElement("div", {
    className: "overlay"
  }, /*#__PURE__*/React.createElement("div", {
    className: "playerCtn"
