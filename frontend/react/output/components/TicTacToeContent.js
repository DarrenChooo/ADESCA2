...
/////////////////////////////////////////////////////////////////////
import TicTacToePlayerTurn from "./TicTacToePlayerTurn.js";
import TicTacToeBoardCell from "./TicTacToeBoardCell.js";
import TicTacToePlayerPic from "./TicTacToePlayerPic.js";
...
export default function TicTacToeContent({
      ...
      combos[combo].forEach(pattern => {
        if (squares[pattern[0]] === "" || squares[pattern[1]] === "" || squares[pattern[2]] === "") {
          ...
          if (squares[pattern[0]] === Players.Human.symbol) {
            ...
            axios.get(CURRENCY_URL + userid, {}).then(response => {
            ...
            axios.put(USER_URL + `/floor/${userid}`, {
              floorid: Number(getFloorId) + 1
            }).then(() => {
            ...
            axios.get(GAMEDURATION_URL + `/${gameId}/${userid}`, {}).then(response => {
  ...
  React.useEffect(() => {
    axios.get(USER_URL + 'join/' + userid, {}).then(user => {
      axios.get(FLOOR_URL + user.data.floorid, {}).then(floor => {
  ...
  const TicTacToeBoardCell = ({
    num
  }) => {
    return /*#__PURE__*/React.createElement("td", {
      style: {
        cursor: cells[num] === "" && turn === Players.Human.symbol && !winner ? "crosshair" : "not-allowed"
      },
  ...
  const compTurn = () => {
    setTimeout(() => {
      ...
      if (cloneCells[randomNum] !== "") {
        ...
        setCells(cloneCells, setTurn(Players.Human.symbol));
      }
    }, 500);
  };
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(TicTacToePlayerTurn, {
    symbol: Players.Human.symbol,
    turn: turn,
    winner: winner
  }), winner && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    id: "winText"
  }, winner === "draw" && /*#__PURE__*/React.createElement("button", {
    onClick: () => handleRestart()
  }, "Try Again"), winner === Players.Human.symbol && "You have earned 100 Stardust!", winner === Players.Computer.symbol && /*#__PURE__*/React.createElement("button", {
    onClick: () => handleRestart()
  }, "Try Again"))), /*#__PURE__*/React.createElement("div", {
    id: "content"
  }, /*#__PURE__*/React.createElement(TicTacToePlayerPic, {
    userid: userid,
    symbol: Players.Human.symbol,
    turn: turn,
    winner: winner
    ...
    className: "top"
  }, /*#__PURE__*/React.createElement(TicTacToeBoardCell, {
    num: 0,
    cells: cells
  }), /*#__PURE__*/React.createElement(TicTacToeBoardCell, {
    num: 1,
