...
import RetrieveDialogues from './components/RetrieveDialogues';
...
const ManageDialogues = () => {
    ...
    return (
        <div>
            <AdminNavBar pageTitle="Dialogue Manager" />
            <br />
            <br />
            <br />
            ...
            <div className="bodyContainer">
                <div className="flexContainer">
                    <AdminSearchBar addURL="/admin/react_add_dialogue.html" />

                    <RetrieveDialogues dialogues={dialogues} />
