export default function UpdateBossForm(props) {
    ...
    return (
        <form onSubmit={handleUpdate}>
            <div className="input">
                <label className="inputLabel" >Input Boss Name</label>
                    <input type="text" id="updateBossName" value={bossName} onChange={handleBossNameChange} placeholder={bossName} required />
            </div>
            <div className="input">
                <label className="inputLabel">Input Boss Health:</label>
                    <input type="number" id="updateBossHealth" value={bossHealth} onChange={handleBossHealthChange} placeholder="Eg: '50'" required />
            </div>
            <div className="input">
                <label className="inputLabel">Input Boss Reward</label>
                    <input type="number" id="updateBossReward" value={bossReward} onChange={handleBossRewardChange} placeholder="Eg: '100'" required />
            </div>
            <div className="input">
                <label className="inputLabel">Input Boss Image ID</label>
                    <input type="number" id="updateBossImage" value={bossImage} onChange={handleBossImageChange} placeholder="Eg: '26'" required />
            </div>
            <div className="button-container">
                <button className="button" type="submit" id="updateButton">Update</button>
            </div>
        </form>    
    );
  }
