        ...
        <div className="card">
            <div className="dataCtn">
                <form onSubmit={handleSubmitForm}>
                    <div className="input">
                        <input type="text" id="dialogueIdIpt" placeholder="Eg: 22" value={dialogueId} onChange={handleDialogueIdInput} />
                        <label className="inputLabel">Dialogue ID</label>
                    </div>
                    <div className="input">
                        <input type="text" id="dialogueDescIpt" placeholder="Eg: Welcome to Stardust Neverland!" value={dialogueDesc} onChange={handleDialogueDescInput} />
                        <label className="inputLabel">Dialogue Description</label>
                    </div>
                    <div className="input">
                        <input type="text" id="npcIdIpt" placeholder="Eg: 22" value={npcId} onChange={handleNpcIdInput} />
                        <label className="inputLabel">NPC ID</label>
                    </div>
                    <div className="input">
                        <input type="text" id="plotIdIpt" placeholder="Eg: 1" value={plotId} onChange={handlePlotIdInput} />
                        <label className="inputLabel">Plot ID</label>
                    </div>
                    <div className="input">
                        <input type="text" id="stateIdIpt" placeholder="Eg: 0" value={stateId} onChange={handleStateIdInput} />
