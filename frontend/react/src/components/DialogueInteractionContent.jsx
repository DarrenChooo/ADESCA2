...
export default function DialogueInteractionContent(props) {
    ...
    return (
        <div>
            <div id="card">
                ...
                {dialogueid === 10 && (
                    <>
                        ...
                        <div id="choosePlot">
                            <div>
                                <button className="choosePlotBtn" id="plot2" type="button" onClick={plot2Clicked}>I'm here for a treasure hunt. </button>
                            </div>
                            <div>
                                <button className="choosePlotBtn" id="plot3" type="button" onClick={plot3Clicked}>I'm looking for my long-lost family. </button>
                            </div>
                            <div>
                                <button className="choosePlotBtn" id="plot4" type="button" onClick={plot4Clicked}>I'm here for an adventure. </button>
                            </div>
                ...
                <div id="npcPic">
                    <img className="image" src={IMAGE_URL + props.npcImageUrl} width="100%" height="60%" />
                    <figcaption>
                        <h2>{props.npcName}</h2>
                    </figcaption>
                </div>
            ...
            <div id="btnSection">
                <button id="backIntroDialogue" type="button" onClick={backBtn}>Back</button>
                <button id="getIntroDialogue" type="button" onClick={nextBtn}>Next</button>
            </div>
